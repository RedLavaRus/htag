...
class Hleb_krosh
{
	...
	public function fun_echo($pdo,$p1,$p2,$p3,$p4,$p5,$p6,$p7,$p8,$p9,$p10)
	{
		...
		if($this->lvl1_name != "")
		{
			...
			$qwerty = $this->lvl1_url; // специально для вас. я добро.
		}
		...
		$this->lvl2_url = $this->lvl1_url.$p2."/";
		if($this->lvl2_name != "")
		{
			echo " <a href=\"".$this->lvl2_url."\">".$this->lvl2_name." /</a> ";  
			$qwerty = $this->lvl2_url;  
		}
		...
		$this->lvl3_url =  $this->lvl2_url.$p3."/";
		if($this->lvl3_name != "")
		{
			echo "<a href=\"".$this->lvl3_url."\">".$this->lvl3_name." / </a> ";  
			$qwerty = $this->lvl3_url; 
		}
		...
		$this->lvl4_url = $this->lvl3_url.$p4."/";;
		if($this->lvl4_name != "")
		{
			echo "<a href=\"".$this->lvl4_url."\">".$this->lvl4_name." / </a> ";  
			$qwerty = "<a href=\"".$this->lvl4_url."\">".$this->lvl4_name." / </a> ";  
		}
		...
		$this->lvl5_url = $this->lvl4_url.$p5."/";
		if($this->lvl5_name != "")
		{
			echo "<a href=\"".$this->lvl5_url."\">".$this->lvl5_name." / </a> ";  
			$qwerty = "<a href=\"".$this->lvl5_url."\">".$this->lvl5_name." / </a> ";  
		}
		...
		$this->lvl6_url = $this->lvl5_url.$p6."/";
		if($this->lvl6_name != "")
		{
			echo "<a href=\"".$this->lvl6_url."\">".$this->lvl6_name." / </a> ";  
			$qwerty = "<a href=\"".$this->lvl6_url."\">".$this->lvl6_name." / </a> ";  
		}
		...
		$this->lvl7_url = $this->lvl6_url.$p7."/";
		if($this->lvl7_name != "")
		{
			echo "<a href=\"".$this->lvl7_url."\">".$this->lvl7_name." / </a> ";  
			$qwerty = "<a href=\"".$this->lvl7_url."\">".$this->lvl7_name." / </a> ";   
		}
		...
		$this->lvl8_url = $this->lvl7_url.$p8."/";
		if($this->lvl8_name != "")
		{
			echo "<a href=\"".$this->lvl8_url."\">".$this->lvl8_name." / </a> ";  
			$qwerty =  "<a href=\"".$this->lvl8_url."\">".$this->lvl8_name." / </a> ";  
		}
		...
		$this->lvl9_url = $this->lvl8_url.$p9."/";
		if($this->lvl9_name != "")
		{
			echo "<a href=\"".$this->lvl9_url."\">".$this->lvl9_name." / </a> ";  
			$qwerty = "<a href=\"".$this->lvl9_url."\">".$this->lvl9_name." / </a> ";  
		}
		...
		$this->lvl10_url = $this->lvl9_url.$p10."/";;
		if($this->lvl10_name != "")
		{
			echo "<a href=\"".$this->lvl10_url."\">".$this->lvl10_name." / </a> ";  
			$qwerty = $this->lvl10_url;
		}
		return $qwerty;
	}
