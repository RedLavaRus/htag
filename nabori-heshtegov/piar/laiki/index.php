...
<div class="contaner">
	...
	<div class="l_boc">
		...
		<br>
				<?php
		$group_stranich = new Group_stranich;
		$group_stranich->heshtag_nabor_vivod_pod_group($pdo,$navigator ->url_lvl1,$navigator ->url_lvl2,$navigator ->url_lvl3,$navigator ->url_lvl4,$navigator ->$url_lvl5,$navigator ->url_lvl6,$navigator ->url_lvl7,$navigator ->url_lvl8,$navigator ->url_lvl9,$navigator ->url_lvl10);
		?>
		<div class="clear"></div><br>
